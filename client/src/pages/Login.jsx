...
import { Mail, Lock, Loader2, Wallet, ArrowRight, CheckCircle2 } from 'lucide-react';
    ...
    >
      ...
      <div className="hidden lg:flex lg:col-span-7 bg-[#0b0f19] border-r border-slate-800/40 relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="max-w-md relative z-10 my-auto">
          ...
          >
            Take command of your <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">spending habits.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Monitor expenditures, manage monthly budget thresholds, and unlock AI-inspired insights to save more and optimize cash flows.
          </motion.p>
      ...
      <div className="lg:col-span-5 flex items-center justify-center p-6 sm:p-12 relative">
        ...
        >
          ...
          <p className="text-slate-500 text-sm text-center mb-8">
            Access your secure personal dashboard
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold transition-all shadow-md shadow-indigo-500/20 text-sm flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.99] disabled:opacity-50"
            >
              {loading ? (
                <>
